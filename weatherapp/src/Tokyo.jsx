...
function Tokyo() {
    ...
    const getWeatherIcon = (conditionCode) => {
        // Adjust the path to your icon files accordingly
    ...
    // Assuming 'weatherData' is structured similarly for Tokyo as it was for Berlin
    ...
    const showForecast = () => {
        ...
        Swal.fire({
            title: '<strong>Future Forecast for Tokyo</strong>',
            html: forecastHtml,
