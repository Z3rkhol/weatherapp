...
function Prague() {
    ...
    const getWeatherIcon = (conditionCode) => {
        return `/path/to/icons/${conditionCode}.png`; // Adjust the path to your weather icons
    };
    ...
    const showForecast = () => {
        ...
        MySwal.fire({
            title: '<strong>Future Forecast for Prague</strong>',
            html: forecastHtml,
    ...
    return (
        <div className="weather-container">
            <h2 className="city-name">Prague</h2>
